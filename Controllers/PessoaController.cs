...
namespace EMISSOR_DE_CERTIFICADOS.Controllers
{
    public class PessoaController : Controller
    {
        ...
        public IActionResult Details_OLD(int id)
        {
        ...
        [HttpGet]
        public IActionResult BuscarPessoas_OLD(string termo)
        {          

            var pessoas = BuscarPorNomeCpfEmail(termo).Select(p => new {p.Id, p.Nome, p.CPF, p.Email}).ToList();
            return Json(pessoas);
        }
        ...
        public IActionResult Create_OLD(PessoaModel pessoa)
        {
        ...
        // GET: Pessoa/Edit/5
        public IActionResult Edit_OLD(int id)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit_OLD(int id, PessoaModel pessoa)
        {
            if (id != pessoa.Id)
            {
                return BadRequest();
        ...
        // GET: Pessoa/Delete/5
        public IActionResult Delete_OLD(int id)
        {
        ...
        [ValidateAntiForgeryToken]
        public IActionResult DeleteConfirmed_OLD(int id)
        {
        ...
        private IEnumerable<PessoaModel> BuscarPorNomeCpfEmail(string termo)
        {
            try
            {
        ...
        //Método que valida se a pessoa existe através do CPF
        ...
        //Método que retorna o ID da pessoa através do CPF
        ...
        //Método que retorna o CPF da pessoa através do ID
        ...
        //Método que retorna o Nome da pessoa através do ID
